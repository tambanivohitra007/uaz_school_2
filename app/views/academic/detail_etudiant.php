                                ...
                                foreach ($summary as $value) {
                                  ...
                                  echo '<li>
                                    <div class="message_wrapper">
                                      ...
                                      <blockquote class="message">' . $this->lang->line('total_credit') . ': ' . $value['total_credit'] . ' </blockquote>
                                      <blockquote class="message">' . $this->lang->line('gpa_sem') . ': ' . number_format($value['moyenne_sem'] , 2) . '</blockquote>
                                      <blockquote class="message">' . $this->lang->line('gpa_maj') . ': ' . number_format($majeur->moyenne_majeur, 2) . '</blockquote>
                                      <blockquote class="message">' . $this->lang->line('nb_cours_r') . ': ' . $cours_reussi->isa . '</blockquote>
                                      <blockquote class="message">' . $this->lang->line('nb_cours_a_r') . ': ' . $cours_a_refaire->isa . '</blockquote>
                                      <br />
