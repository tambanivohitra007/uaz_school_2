                ...
                <footer>
                    <div class="">
                        <p class="pull-right">Université Adventiste Zurcher, Copyright 2016 --
                          <a href="http://tambanivohitra.wordpress.com"> <strong>Rindra.it</strong></a>
                    </div>
    ...
    <!-- Datatables -->
     ...
     <script src="<?php echo base_url(); ?>assets/js/datatables/js/dataTables.rowGroup.min.js"></script>
     <script src="<?php echo base_url(); ?>assets/js/datatables/js/dataTables.responsive.min.js"></script>
     <script src="<?php echo base_url(); ?>assets/js/datatables/js/responsive.bootstrap.min.js"></script>
    <!-- chart js -->
