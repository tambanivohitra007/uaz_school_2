                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3><?php echo $this->lang->line('title_list'); ?> <?php echo $dep; ?></h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><?php echo $this->lang->line('title_table_list'); ?> <?php echo $dep; ?></h2>
                                ...
                                <table id="table" class="table table-striped projects responsive-utilities jambo_table">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                              <td><a href="#" onclick="showAjaxModal('<?php echo site_url("departement/popup/" . $objet['student_id']);?>')" class="btn btn-success btn-xs btn-icon icon-left" id="voir"> <i class="fa fa-spin"> </i> <?php echo $this->lang->line('see_detail'); ?> </a>
                                                <a href="<?php echo site_url("departement/list_detail/" . $objet['student_id']);?>" class="btn btn-primary btn-xs">Checklist</a></td>
