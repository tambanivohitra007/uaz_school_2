<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        ...
        <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"> Université Adventiste Zurcher</a>
        </div>

        <div class="profile"><!--img_2 -->
            <div class="profile_pic">
                <img src="<?php echo base_url() . 'assets/uploads/' . $this->session->userdata('admin_username') . '.jpg';?>" alt="..." class="img-circle profile_img">
            </div>
